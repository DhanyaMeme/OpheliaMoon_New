  ...
  return (
    <div className="policy-content">
      ...
      <p className="policy-text  u-h4">
        ...
        access and use of OpheliaMoon services and the OpheliaMoon website
      ...
      <ul>
        ...
        <li>
          ...
          this Agreement) refers to OpheliaMoon.
        </li>
        <li>
        ...
        <li>
          Website refers to OpheliaMoon, accessible from
      ...
      <p className="policy-text  u-h4">
        By visiting this page on our website: [OpheliaMoon] (OpheliaMoon)
      </p>
    </div>
  );
};
