...
function TermsOfService() {
  return (
    <div className="policy-content">
      <div className="policy-head u-h3">OpheliaMoon Terms of Service</div>
      ...
      <ul>
        ...
        <li>
          ...
          “Us” or “Our” in this Agreement) refers to OpheliaMoon.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to OpheliaMoon, accessible from
          <a href="https://OpheliaMoon.in/">https://OpheliaMoon.in/</a>
        </li>
        <li>
      ...
      <ul>
        <li>By email : contact@OpheliaMoon.in</li>
        <li>By visiting this page on our website : https://OpheliaMoon.in/</li>
